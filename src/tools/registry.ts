...
export const toolMetas: ToolMeta[] = [
  ...
  },
  {
    ...
    content: {
      ...
      howToUse: [
        "Open the page — the current Moon phase, illumination, and a yes/no full-moon answer appear instantly for your local date.",
        "Check the countdown cards for the exact date and time of the next full moon and new moon.",
        "Use the date picker to look up the Moon phase on any past or future date.",
        "Browse the 2026 full moon table for names, supermoons, the blue moon, and eclipses.",
        "Click \"Add all 2026 full moons to calendar\" to download an .ics file and import it into Apple, Google, or Outlook calendars.",
      ],
      features: [
      ...
      faq: [
        { question: "Is it a full moon tonight?", answer: "The tool answers this instantly at the top of the page for your local date. The full moon is the moment the Moon is exactly opposite the Sun; we mark the calendar day that instant falls on as the full-moon day. In 2026 the full moons fall on Jan 3, Feb 1, Mar 3, Apr 1, May 1, May 31, Jun 29, Jul 29, Aug 28, Sep 26, Oct 26, Nov 24, and Dec 23 (US Eastern)." },
        { question: "When is the next full moon?", answer: "The countdown card shows the exact date, time, and days remaining until the next full moon, updated live. Each full moon also has a traditional name, such as the Strawberry Moon in June or the Harvest Moon in September." },
        { question: "What moon phase is it right now?", answer: "The page displays the current phase — one of New, Waxing Crescent, First Quarter, Waxing Gibbous, Full, Waning Gibbous, Last Quarter, or Waning Crescent — along with the exact illuminated percentage and the Moon's age in days." },
        { question: "What is a blue moon and when is the next one?", answer: "A blue moon is the second full moon within a single calendar month. It has nothing to do with color. The next blue moon is May 31, 2026, which is also a micromoon — the smallest and faintest full moon of the year." },
        { question: "What is a supermoon?", answer: "A supermoon is a full moon that occurs near perigee, the Moon's closest point to Earth. It looks about 14% larger and 30% brighter than a typical full moon. 2026 has three supermoons: January 3, November 24, and December 23." },
        { question: "What are the names of the full moons?", answer: "Each month's full moon has a traditional name from Native American and colonial sources: Wolf (Jan), Snow (Feb), Worm (Mar), Pink (Apr), Flower (May), Strawberry (Jun), Buck (Jul), Sturgeon (Aug), Harvest/Corn (Sep), Hunter's (Oct), Beaver (Nov), and Cold (Dec)." },
        { question: "How accurate is this moon phase calculator?", answer: "Phase instants are computed with the Jean Meeus algorithm from Astronomical Algorithms, which matches the U.S. Naval Observatory to within about one minute. Unlike simple average-cycle estimates, it will not place a full moon on the wrong calendar day." },
        { question: "How do I add full moons to my calendar?", answer: "Click the \"Add all 2026 full moons to calendar\" button to download a standard .ics file. Open it to import every 2026 full moon into Apple Calendar, Google Calendar, or Outlook in one step — completely free." },
        { question: "Why does the Moon look full for several nights?", answer: "The full moon is a single instant, but the Moon appears more than 98% illuminated for about a day on either side, so it looks round to the eye for two to three nights. The exact full-moon moment is what determines the official date." },
      ],
      relatedSlugs: ["national-days-calendar", "timestamp-converter", "ai-token-calculator"],
    },
  },
  {
    slug: "national-days-calendar",
    title: "What National Day Is Today? - Calendar & Dates",
    shortTitle: "National Days Calendar",
    description: "Free national days calendar. See what national day is today, get exact dates and countdowns for National Donut Day, Coffee Day, Pizza Day and more.",
    category: "calendar",
    keywords: ["what national day is today", "national days calendar", "national donut day 2026", "national day today", "national food days", "national coffee day", "what national day is it"],
    content: {
      whatIs: "This National Days Calendar tells you instantly what national day it is today and what fun food and themed days are coming up next. The United States observes hundreds of national days every year — National Donut Day, National Coffee Day, National Pizza Day, National Taco Day, and many more — and most of them repeat annually, so the same celebrations (and brand freebies) come back every year. This tool gives a clean, fast, ad-light answer instead of the cluttered, overloaded pages most calendar sites serve.\n\nThe page shows today's national days at the top, then a chronological list of upcoming days with a countdown to each one. You can filter by category — Food & Drink, Fun & Quirky, Health, and Awareness — to find the celebrations you care about. Every day includes a short, factual description of its origin, and you can add any day to your own calendar with one click as an .ics file.\n\nMany national days fall on a fixed date (National Coffee Day is always September 29), but others float — National Donut Day is the first Friday of June, National Ice Cream Day is the third Sunday of July. This tool computes the correct date for every year automatically using the underlying rule, so it stays accurate year after year without manual updates. Where sources genuinely disagree on a date, the most widely cited one is shown and clearly marked.",
      explained: "National days come in three date types, and getting them right is what separates an accurate calendar from a guess. Fixed-date days always fall on the same month and day, like National Pizza Day on February 9. Floating days fall on the Nth weekday of a month — National Donut Day is the first Friday of June, computed by finding the first Friday on or after June 1. Easter-relative days, like Shrove Tuesday (the traditional Pancake Day), are offset from Easter Sunday, which itself is found with the Anonymous Gregorian algorithm.\n\nThis tool encodes each day as a rule rather than a hard-coded date, then resolves the actual calendar date for whatever year you are viewing. That means National Donut Day correctly shows June 5 in 2026 and June 4 in 2027 without anyone editing the data. Floating-date days are the ones content-farm calendars most often get wrong, because they copy last year's date forward.\n\nSome national days genuinely have competing dates from different sources — National Hamburger Day is most often May 28 but is also listed elsewhere on July 28, and National Taco Day moved from a fixed October 4 to the first Tuesday of October in 2024. Rather than hide this, the tool marks disputed days so you know the date can vary, which is more honest and more useful than a single unsourced number.",
      useCases: [
        "Finding out what national day is today for a social media post, caption, or office celebration.",
        "Planning ahead for National Donut Day, Coffee Day, or Pizza Day to catch the brand freebies and deals.",
        "Building a content or marketing calendar by browsing which themed days are coming up this month.",
        "Looking up the exact date of a specific national day for this year or next.",
        "Adding a favorite food day to your phone calendar so you get a reminder every year.",
        "Discovering quirky, health, or awareness days to celebrate with friends, family, or coworkers.",
      ],
      tips: [
        "Floating days move every year. National Donut Day is the first Friday of June (June 5 in 2026), not a fixed date — this tool recalculates it automatically so you never miss it.",
        "The biggest brand freebies cluster around food days like Donut Day, Coffee Day, and Free Cone Day. Add them to your calendar a few days early so you can plan.",
        "Some days have more than one accepted date. Where that happens, the day is marked \"date varies\" — check the official brand or organizer if timing matters.",
        "National Coffee Day in the US is September 29, but International Coffee Day is October 1. They are different days, so deals can appear on both.",
        "Use the category filter to cut the noise — pick Food & Drink for freebies, or Awareness for observances like World Mental Health Day.",
      ],
      howToUse: [
        "Open the page to see today's national day (or days) highlighted at the top.",
        "Scroll the upcoming list to see what is coming next, each with a live countdown.",
        "Use the category buttons to filter by Food & Drink, Fun, Health, or Awareness.",
        "Read the short origin description for any day you are curious about.",
        "Click \"+ .ics\" next to any day to add it to your Apple, Google, or Outlook calendar.",
      ],
      features: [
        "Instant answer to \"what national day is today\"",
        "Upcoming national days with a live countdown to each",
        "Accurate fixed and floating dates computed for any year",
        "Category filters: Food & Drink, Fun, Health, Awareness",
        "One-click .ics calendar export for any day",
        "Honest \"date varies\" markers where sources disagree",
      ],
      faq: [
        { question: "What national day is today?", answer: "The tool shows today's national day (or days) at the very top of the page, based on your local date. The US observes hundreds of national days a year, so most days have at least one celebration — from food days like National Donut Day to awareness days like World Mental Health Day." },
        { question: "When is National Donut Day 2026?", answer: "National Donut Day 2026 is Friday, June 5, 2026. It always falls on the first Friday of June, a tradition started by the Salvation Army in 1938. A separate fixed-date Donut Day is also observed on November 5." },
        { question: "When is National Coffee Day 2026?", answer: "National Coffee Day in the United States is September 29, 2026. It is a fixed date every year. Note that International Coffee Day is a separate observance on October 1, so coffee deals can appear on both days." },
        { question: "When is National Pizza Day 2026?", answer: "National Pizza Day is February 9, 2026. It is a fixed-date holiday celebrated every February 9, and pizzerias often run slice deals and buy-one-get-one offers to mark it." },
        { question: "Why do some national days change dates each year?", answer: "Many national days are defined as a weekday rather than a fixed date — National Donut Day is the first Friday of June, National Ice Cream Day is the third Sunday of July. This tool computes the correct date for each year automatically using the rule, so the date is always right." },
        { question: "How many national days are there?", answer: "There are hundreds. Calendar registries list thousands of observances across food, fun, health, and awareness categories, with many days carrying several celebrations at once. This tool focuses on the most-searched and most-celebrated US national days." },
        { question: "Are National Day dates official?", answer: "Some days are congressionally or presidentially proclaimed (like National Ice Cream Month, 1984), but most are promoted by brands, organizations, or registries rather than by law. This tool uses the most widely cited date and marks days where sources disagree." },
        { question: "How do I add a national day to my calendar?", answer: "Click the \"+ .ics\" link next to any day in the list to download a calendar file. Open it to add that day to Apple Calendar, Google Calendar, or Outlook, with the correct date for the year — free and with no signup." },
      ],
      relatedSlugs: ["moon-phase-calendar", "timestamp-converter", "word-counter"],
    },
  },
];
